...
// Ambil nama pengguna dan PEGID dari session
$user_name = $_SESSION['pendamping']['Nama_pendamping'] ?? 'User';
$pegid = $_SESSION['pendamping']['PEGID'];

// Ambil data kunjungan untuk pengguna yang sedang login
$sql = "SELECT 
            l.nama_madrasah,
...
<body class="bg-gray-100 font-sans antialiased">
    <div class="flex flex-col md:flex-row">
        ...
        <div class="md:hidden flex justify-between items-center bg-gradient-to-r from-green-600 to-green-800 text-white p-4 shadow-lg">
            <h1 class="text-lg font-semibold"><?php echo htmlspecialchars($user_name); ?></h1>
        ...
        <div id="sidebar" class="sidebar w-full md:w-64 bg-gradient-to-b from-green-800 to-green-600 text-white min-h-screen hidden md:block shadow-lg">
            <div class="text-center mt-10">
                <h1 class="text-xl font-bold tracking-wide"><?php echo htmlspecialchars($user_name); ?></h1>
            </div>
            <nav class="mt-10">
                ...
                <a class="flex items-center py-3 px-8 bg-green-500 text-white rounded-lg hover:bg-green-400 transition-all duration-300" href="rekap_kinerja.php">
        ...
        <div class="flex-1 p-6 md:p-10">
            <div class="sticky top-0 bg-gray-100 z-10">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-4xl font-extrabold text-gray-700">REKAP KINERJA</h1>
                </div>
                <div class="relative mb-6">
                    <input id="searchInput" onkeyup="searchTable()" class="w-full py-3 pl-12 pr-4 rounded-lg border border-gray-300 shadow focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Cari Data Rekap Kinerja" type="text" />
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo '<tr>
                                    ...
                                    <td><strong>' . htmlspecialchars($row["jumlah_kunjungan"]) . '<strong></td>
                                </tr>';
                        }                       
