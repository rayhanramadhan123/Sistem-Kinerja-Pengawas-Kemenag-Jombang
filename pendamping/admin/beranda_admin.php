...
$admin_name = isset($_SESSION['admin']['username_admin']) ? $_SESSION['admin']['username_admin'] : 'Admin';
...
$stmt_total_binaan->bind_param("i", $admin);
...
$stmt_total_kunjungan->bind_param("i", $admin);
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="bg-cover bg-center h-48 rounded-xl" style="background-image: url('../image/asset2.png')">
                <div class="bg-gray-500 bg-opacity-50 p-6 mb-8 mt-8 flex items-center space-x-6 rounded-lg shadow-md">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white mb-2">Selamat Datang, <?php echo $admin_name; ?>!</h1>
            ...
            <section id="menu-section" class="mt-20 bg-white bg-opacity-20 p-4 rounded-lg shadow-lg md:p-20 scroll-animate">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                    ...
                    <div class="scroll-reveal text-center">
                        <a href="info_binaan.php" class="block p-4 bg-white bg-opacity-70 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 md:p-6">
                            <i class="fas fa-database text-4xl text-yellow-500 mb-4 md:text-5xl"></i>
                            <h3 class="text-lg font-semibold md:text-xl">Informasi Binaan</h3>
                        </a>
                    </div>

                    <div class="scroll-reveal text-center">
                        <a href="laporan_kunjungan.php" class="block p-4 bg-white bg-opacity-70 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 md:p-6">
                            <i class="fas fa-calendar-check text-4xl text-blue-600 mb-4 md:text-5xl"></i>
                            <h3 class="text-lg font-semibold md:text-xl">Laporan Kunjungan</h3>
                        </a>
                    </div>

                    <div class="scroll-reveal text-center">
                        <a href="laporan_kinerja.php" class="block p-4 bg-white bg-opacity-70 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 md:p-6">
                            <i class="fas fa-file-alt text-4xl text-blue-500 mb-4 md:text-5xl"></i>
                            <h3 class="text-lg font-semibold md:text-xl">Laporan Kinerja</h3>
                        </a>
                    </div>

                    <div class="scroll-reveal text-center">
                        <a href="laporan_total_kinerja.php" class="block p-4 bg-white bg-opacity-70 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 md:p-6">
                            <i class="fas fa-chart-line text-4xl text-yellow-500 mb-4 md:text-5xl"></i>
                            <h3 class="text-lg font-semibold md:text-xl">Raport Kinerja</h3>
                        </a>
                    </div>
            ...
            <section id="info-section" class="mt-[50vh] mb-16 scroll-animate">
                <div class="bg-white bg-opacity-65 rounded-xl shadow-lg p-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex justify-between items-center mb-6">
                            <button onclick="location.href='upload_informasi.php'" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full transition duration-200 ease-in-out">
                                <i class="fas fa-cloud-upload-alt text-lg mr-2"></i>
                                Upload Informasi
                            </button>
                        </div>
                    </div>
                                    ...
                                    <div class="mt-4 flex justify-between items-center">
                                        <?php if($row['file_type'] == 'image'): ?>
                                            <button onclick="showImageModal('../uploads/informasi/<?php echo htmlspecialchars($row['file_path']); ?>')" 
                                                ...
                                                Tampilkan <i class="fas fa-eye ml-1"></i>
                                            </button>
                                        <?php else: ?>
                    ...
                    <div class="flex justify-end mt-4">
                        <a href="informasi.php" class="text-blue-600 hover:text-green-800 font-medium">
